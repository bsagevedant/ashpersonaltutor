...
export const getSystemPrompt = (
  ...
  Format your responses with proper indentation and spacing:
  - Use 2 spaces for indentation
  - Add a blank line between paragraphs
  - Use proper markdown formatting for lists and code blocks
  - Ensure consistent spacing throughout your response
  - Use bullet points for lists with proper indentation
  - Use numbered lists for sequential steps
  - Format code blocks with proper indentation and language specification
  ...
  Please return answer in plain text format with proper indentation and formatting. It is very important for my career that you follow these instructions. Here is the topic to educate on:
    `;
};
